...
dfold = pd.read_csv('deathrate_/PythonProjectmilo/DataFiles/age-between-15-and-49.csv')
dfold = dfold.dropna()
...
dfyoung = pd.read_csv('deathrate_/PythonProjectmilo/DataFiles/age-between-5-and-14.csv')
...
dftodlers = pd.read_csv('deathrate_/PythonProjectmilo/DataFiles/under-age-5.csv')
...
dfveryold = pd.read_csv('deathrate_/PythonProjectmilo/DataFiles/age-between-50-and-69.csv')
